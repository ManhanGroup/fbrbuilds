...
module('Integration | Component | development form', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    assert.dom('*').hasText("Create Development Development Name Latitude Longitude Drag map to set location Meta Data Developer Description PROJID Traffic Count URL Key Info Open to Public View? Status Select Status Completed In Construction Planning Projected Unverified Year complete Complete Date Estimated? Cost of Construction $ Project Area Height Number of Stories Number of Parking Spaces Parking Type Garage Underground Surface Other Attributes: Redevelopment , Phased , Stalled , As of Right , Mixed Use Residential Group Quarters Population Attributes: Age Restricted Housing Units Enter quantity of each unit type below Unit Type Quantity Percentage Single Family 0% Multi-family 0% Medium Density Multi-family 0% High Density Multi-family 0% Mobile Home 0% Unknown 0% Unit Style Quantity Percentage Studio/1 Bedroom 0% 2 Bedroom 0% 3 Bedroom 0% Affordable Units Enter quantity of each unit type below Unit Type Quantity Percentage Units <30% AMI 0% Units 30-50% AMI 0% Units 50-80% AMI 0% Above Units 80% AMI 0% Unknown 0% Commercial Reported Employment Hotel Rooms Public Area Attributes: Company Headquarters Commercial Area Enter the floor area for each use type below Use Type Floor Area (sqft.) Percentage Retail 0% Office/Medical 0% Industrial/Manufacturing 0% Warehouse/Shipping 0% Research/Development 0% Educational/Institutional 0% Hotel Room 0% Other 0% Unknown 0% * = required field");
