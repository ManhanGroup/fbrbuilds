...
export default class extends Component {
  ...
  didInsertElement() {
    ...
    this.mapboxglMap = new mapboxgl.Map({
      ...
      style: mapStyle,
      center: [mapService.ctr.lng, mapService.ctr.lat],
      zoom: mapService.get('currentZoom'),
      maxBounds: [
        [mapService.lower.lng, mapService.lower.lat ],
        [mapService.upper.lng , mapService.upper.lat],
      ],
      dragRotate: false,
  ...
  draw(mapService) {
    ...
    const openPopup = (e) => {
      ...
      const content = htmlSafe(`
        <div class='fbrbuilds-tooltip'</div>
